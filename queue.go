...
import (
	...
	"github.com/maxpoletaev/gossip/internal/heap"
...
func NewQueue() *MessageQueue {
	q := &MessageQueue{
		...
		pq: heap.New(func(a, b *proto.Payload) bool {
			...
			return (!wrapped && a.SeqNumber < b.SeqNumber) ||
				(wrapped && a.SeqNumber > b.SeqNumber)
		}),
	}
...
func (q *MessageQueue) FindGaps() []uint64 {
	...
	waiting := make([]uint64, 0, len(q.waiting))
	for seq := range q.waiting {
